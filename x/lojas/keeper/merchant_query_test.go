...
func TestQueryMerchantByID(t *testing.T) {
	...
	merchant := types.Merchant{Id: 7, Nome: "Query", Creator: "creator", OperatorAddress: "creator", KycStatus: "approved"}
	...
	require.Equal(t, "approved", resp.Merchant.KycStatus)
}
...
func TestMerchantAllReturnsID(t *testing.T) {
	...
	merchants := []types.Merchant{
		{Id: 3, Nome: "Loja1", KycStatus: "pending"},
		{Id: 4, Nome: "Loja2", KycStatus: "approved"},
	}
