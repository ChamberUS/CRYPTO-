...
import (
	...
	evmconfig "github.com/buynnex/iaos-evmd/config"
	...
	feesplitkeeper "github.com/buynnex/iaos-evmd/x/feesplit/keeper"
	feesplit "github.com/buynnex/iaos-evmd/x/feesplit/module"
	feesplittypes "github.com/buynnex/iaos-evmd/x/feesplit/types"
	lojaskeeper "github.com/buynnex/iaos-evmd/x/lojas/keeper"
	lojasmodule "github.com/buynnex/iaos-evmd/x/lojas/module"
	lojastypes "github.com/buynnex/iaos-evmd/x/lojas/types"
	paymentskeeper "github.com/buynnex/iaos-evmd/x/payments/keeper"
	paymentsmodule "github.com/buynnex/iaos-evmd/x/payments/module"
	paymentstypes "github.com/buynnex/iaos-evmd/x/payments/types"
...
func NewExampleApp(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		evmtypes.StoreKey, feemarkettypes.StoreKey, erc20types.StoreKey, precisebanktypes.StoreKey, feesplittypes.StoreKey,
		// BYX modules
		lojastypes.StoreKey, paymentstypes.StoreKey,
	)
	...
	app.FeesplitKeeper = feesplitkeeper.NewKeeper(
		runtime.NewKVStoreService(keys[feesplittypes.StoreKey]),
		appCodec,
		app.BankKeeper,
	)

	app.LojasKeeper = lojaskeeper.NewKeeper(
		runtime.NewKVStoreService(keys[lojastypes.StoreKey]),
		appCodec,
		evmaddress.NewEvmCodec(sdk.GetConfig().GetBech32AccountAddrPrefix()),
	...
	*/
	...
	app.ModuleManager = module.NewManager(
		...
		feesplit.NewAppModule(feesplit.AppModuleInputs{Keeper: app.FeesplitKeeper, Cdc: appCodec}),
		lojasmodule.NewAppModule(appCodec, app.LojasKeeper, app.AccountKeeper, app.BankKeeper),
		paymentsmodule.NewAppModule(appCodec, app.PaymentsKeeper),
	)
	...
	app.ModuleManager.SetOrderEndBlockers(
		...
		evmtypes.ModuleName, erc20types.ModuleName, feemarkettypes.ModuleName, feesplittypes.ModuleName, lojastypes.ModuleName, paymentstypes.ModuleName,
